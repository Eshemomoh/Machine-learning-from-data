 %creat a function that returns finaly layer activation values such
       ...
       %layer dimension
       function [answer,dff_sig3,dff_sig2,dff_sig1,sig1,sig2] = frontprop1(model_activation,model_activation_dff,model_activation_fin,model_activation_dff_fin,...
wei1,wei2,datapoint)
       
          x = datapoint(1:end-1); %y = datapoint(:,end);
